...
// in the list above, because bus ID 19 must depart seven minutes after the timestamp at which bus
// ID 7 departs, bus ID 7 will always also be departing with bus ID 19 at seven minutes after timestamp t.
...
const buses: string[] = lines[1].split(',');
