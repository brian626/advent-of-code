...
// jmp +4 sets the next instruction to the other acc +1 near the bottom. After it increases the accumulator
// from 1 to 2, jmp -4 executes, setting the next instruction to the only acc +3. It sets the accumulator
