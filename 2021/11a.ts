// You enter a large cavern full of rare bioluminescent dumbo octopuses! They seem to not
...
// energy over time and flashes brightly for a moment when its energy is full. Although
// your lights are off, maybe you could navigate through the cave without disturbing the
...
// The energy level of each octopus is a value between 0 and 9. Here, the top-left octopus
// has an energy level of 5, the bottom-right one has an energy level of 6, and so on.
...
// After step 10, there have been a total of 204 flashes. Fast forwarding, here is the
