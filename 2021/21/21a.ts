...
// Players take turns moving. On each player's turn, the player rolls the die three times and adds
// up the results. Then, the player moves their pawn that many times forward around the track (that
// is, moving clockwise on spaces in order of increasing value, wrapping back around to 1 after 10).
// So, if a player is on space 7 and they roll 2, 2, and 1, they would move forward 5 times, to
// spaces 8, 9, 10, 1, and finally stopping on 2.

// After each player moves, they increase their score by the value of the space their pawn stopped
// on. Players' scores start at 0. So, if the first player starts on space 7 and rolls a total of 5,
// they would stop on space 2 and add 2 to their score (for a total score of 2). The game immediately
...
// dice and a 100-sided die falls out. This die always rolls 1 first, then 2, then 3, and so on up
...
// losing player had 745 points and the die had been rolled a total of 993 times; 745 * 993 = 739785.
