...
// let steps = 0;
// let currentPoint = 0;
// let pointsToVisit: number[] = [1,2,3,4];

// while (pointsToVisit.length > 0) {
//     console.log(`${pointsToVisit.length} points left to visit...current point is ${currentPoint}`);

//     let shortestDistance = Infinity;
//     let nearestPoint = -1;
//     for (let i = 0; i < 4; i++) {
//         if (i === currentPoint) { continue; }
//         if (pointsToVisit.includes(i) && shortestDistances[currentPoint][i] < shortestDistance) {
//             shortestDistance = shortestDistances[currentPoint][i];
//             nearestPoint = i;
//         }
//     }

//     if (nearestPoint === -1) { break; }
//     console.log(`nearest point is ${nearestPoint}, which is ${shortestDistance} away`);
//     pointsToVisit = pointsToVisit.filter(x => x !== nearestPoint);
