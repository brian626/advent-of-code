...
console.log(findTotalSizeOfSmallDirectories(directoryTree));
...
function findTotalSizeOfSmallDirectories(d: Directory): number {
    let totalSize = 0;

    for (let i = 0; i < d.directories.length; i++) {
        totalSize += findTotalSizeOfSmallDirectories(d.directories[i]);
    }
