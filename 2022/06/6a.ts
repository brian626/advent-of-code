...
// convinced the other Elves that it would be okay to give you their one malfunctioning device - surely you'll have no problem fixing it.
...
while (true) {
    if (isMarker(line.slice(startPos, startPos + 4))) {
